...
def up_postgre_rabbit_logger_redis():
    #  POSTGRESQL
    os.system(f'docker compose -f {PROJECT_DIR}/ci/stage/services/postgre.yml up -d')
    #  AMQP RABBITMQ
    os.system(f'docker compose -f {PROJECT_DIR}/ci/stage/services/rabbit.yml up -d')
    # DOCKER-LOGGER
    os.system(f'docker compose -f {PROJECT_DIR}/ci/stage/services/logger.yml up -d')
    # REDIS
    os.system(f'docker compose -f {PROJECT_DIR}/ci/stage/services/redis.yml up -d')
    return
...
def up_monitoring():
    os.system(f'docker compose -f {PROJECT_DIR}/ci/stage/services/monitoring.yml up -d')
    return
...
def up_main_api(waiting_database: str = 'true', migrate: str = 'false'):
    ...
    os.system(f'docker compose -f {PROJECT_DIR}/ci/stage/services/main_api.yml up -d')
    unset_migration_env()
    return
...
def up_main_admin(waiting_database: str = 'true', migrate: str = 'false'):
    set_migration_env(waiting_database, migrate)
    os.system(f'docker compose -f {PROJECT_DIR}/ci/stage/services/main_admin.yml up -d')
    unset_migration_env()
    return
...
def up_main_tasks(waiting_database: str = 'true', migrate: str = 'false'):
    set_migration_env(waiting_database, migrate)
    os.system(f'docker compose -f {PROJECT_DIR}/ci/stage/services/main_tasks.yml up -d')
    unset_migration_env()
    return
...
def up_main_beat(waiting_database: str = 'true', migrate: str = 'false'):
    set_migration_env(waiting_database, migrate)
    os.system(f'docker compose -f {PROJECT_DIR}/ci/stage/services/main_beat.yml up -d')
    unset_migration_env()
    return
